    ...
    <main>
      <section class="presentation">
        <div class="introduction">
          ...
          <p style="text-align: center;color: #0c0959;">You can use this account to register with us to any of our products</p>
          <div class="socials">
            <button class="gmail-social btn-effect-8" >
              <i class="fab fa-google fa-1x" style="margin-right: 15px;color: #dd4b39;"></i>Google
            </button>
            <button class="twitter-social btn-effect-8">
              <i class="fab fa-twitter fa-1x" style="margin-right: 15px;color: var(--primary-color);"></i>Twitter
            </button>
          </div>
        </div>
        <!-- register form -->
            ...
            <form id="form-regist" class="form">
              <div class="rightcode">
                <svg class="iconCode" width="44" height="22" viewBox="0 0 44 22" fill="none">
                    <circle opacity="0.5" cx="11" cy="11" r="11" fill="#0c0959ab" />
                    <circle opacity="0.5" cx="22" cy="11" r="11" fill="#0c0959ab" />
              ...
              <div class="form-control">
                ...
                <input type="text" required id="username" placeholder="Enter username" autocomplete="off"/>
              ...
              <div class="form-control">
                ...
                <input type="number" required id="postal-code" placeholder="Enter Postal Code" autocomplete="off"/>
                <small>Error message</small>
              </div>
              <div class="form-control">
              ...
              <button class="btn-effect-8">Submit</button>
            </form>
          </div>
